# 00d4656b-aa50-4f66-a779-f14944d767b3 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `dongjie-wu-academic-cv-2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `dongjie-wu-academic-cv-2.html`
...
- A single self-contained `dongjie-wu-academic-cv-2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `dongjie-wu-academic-cv-2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `dongjie-wu-academic-cv-2.html`
- `dongjie-wu-academic-cv.html`
...
- `assets/Dongjie-Wu-CV.pdf`
- `critique.json`

## Coding checklist for AI tools
1. Inspect `dongjie-wu-academic-cv-2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
